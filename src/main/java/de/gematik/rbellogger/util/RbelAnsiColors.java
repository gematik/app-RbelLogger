...
public enum RbelAnsiColors {
    ...
    RESET("\033[0m"),
    BLACK("\033[0;30m", "schwarz", "schwarzen"),
    RED("\033[0;31m", "rot", "roten"),
    GREEN("\033[0;32m", "grün", "grünen"),
    YELLOW("\033[0;33m", "gelb", "gelben"),
    BLUE("\033[0;34m", "blau", "blauen"),
    PURPLE("\033[0;35m", "magenta", "magentanen"),
    CYAN("\033[0;36m", "türkis", "türkisen"),
    WHITE("\033[0;37m", "weiß", "weiss", "weißen", "weissen"),
