...
public class RbelPathConverterTest {
    ...
    public void convertAbsolutePathWithQueryParameters() {
        ...
        assertThat(((RbelUriElement) rbelElement).getBasicPath().getContent())
            .isEqualTo("/foobar");
        assertThat(((RbelUriElement) rbelElement).getQueryParameter().getElementMap())
    ...
    public void domainAndProtocolAndQuery_shouldConvertNested() {
        ...
        assertThat(((RbelUriElement) rbelElement).getQueryParameter().getChildKeys())
            .containsOnly("code", "ssotoken", "state");
        final RbelElement code = ((RbelUriElement) rbelElement).getQueryParameter().getFirst("code").get();
        assertThat(code)
    ...
    public void urlEscapedParameterValues_shouldContainOriginalContent() {
        ...
        final RbelElement scope = ((RbelUriElement) rbelElement).getQueryParameter().getFirst("scope").get();
    ...
    public void simpleUrlWithoutQuery() {
        final RbelElement rbelElement = RbelLogger.build().getRbelConverter()
            .convertElement("http://redirect.gematik.de/foo/bar");

        assertThat(rbelElement)
            .isInstanceOf(RbelUriElement.class);
        assertThat(((RbelUriElement) rbelElement).getBasicPath().getContent())
            .isEqualTo("http://redirect.gematik.de/foo/bar");
        assertThat(((RbelUriElement) rbelElement).getQueryParameter().getChildElements())
            .isEmpty();
    }
}
